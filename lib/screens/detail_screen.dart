            ...
            Stack(children: [
              ...
              Positioned(
                child: SizedBox(
                  ...
                  child:
                      Image.asset("images/book2.webp", fit: BoxFit.fitHeight),
                ),
              ),
              Positioned(
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: Card(
                    ...
                    color: Colors.white,
                    child: Container(
                      padding: EdgeInsets.symmetric(horizontal: height15 / 3),
                      child: Column(children: [
                        ...
                        Container(
                          padding: EdgeInsets.symmetric(horizontal: height9),
                          child: Text(
                            widget.address,
                            style: const TextStyle(
                              fontSize: 20,
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              padding: EdgeInsets.only(left: height20 / 2),
                              child: Row(
                                children: [
                                  IconTheme(
                                    data: const IconThemeData(
                                      color: Color.fromARGB(255, 244, 199, 36),
                                      size: 22,
                                    ),
                                    child:
                                        StarDisplay(value: widget.ratingStar),
                                  ),
                                  SizedBox(
                                    width: height15 / 3,
                                  ),
                              ...
                              children: [
                                ...
                                Row(children: [
                                  ...
                                  const Text(
                                    ...
                                    style: TextStyle(
                                        fontSize: 25,
                                        color: Color.fromARGB(255, 36, 168, 41),
                                        fontWeight: FontWeight.bold),
                                  ),
                                ]),
                              ],
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              GestureDetector(
                                child: DateWidget(selectedDate: _selectedDate),
                                onTap: () {
                                  _presentDatePicker();
                                },
                              ),
